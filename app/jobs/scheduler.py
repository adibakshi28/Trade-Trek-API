...
from app.jobs.tasks import update_stock_universe_cache, fe_be_websocket_msg_broadcast, sync_snp500_constituents, sync_dormant_stock_subscription_cache, calculate_portfolio_value, delete_stock_history, refresh_dormant_cache_at_market_start, print_dormant
...
def start_scheduler():
    ...
    scheduler.add_job(run_async_job, CronTrigger(hour=9, minute=10, second=0, timezone=config["TIMEZONE"]), id="refresh_dormant_cache_at_market_start", replace_existing=True, args=[refresh_dormant_cache_at_market_start], max_instances=3)
